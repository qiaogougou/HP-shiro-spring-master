	    ...
	    <table>
	       ...
	       <tbody>
	           <tr>
				...
				<!-- 发送消息给servlet，将method的内容set到Http Request里面。
				name表示set到request里面的变量名 。
				提交表单（form）的时候点击submit按钮，就可以提交该form里面的所有信息，
				也就把<input type="hidden" name="method" value="getUsers"/>发送到了后台。
				-->
